...
| Autosave     | 160ms move  | No button — saves ~1s after the last keystroke, and immediately on close. A small check fades in beside the footer, holds 800ms, fades out. No spinner for sub-second work.                                                                                                                                                                               |
